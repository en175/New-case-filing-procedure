...
createApp({
    setup() {
        ...
        const diversionDemoFrames = [
            ...
            {
                role: 'assistant',
                content: '<div class="ai-reply-lead">您好，广州仲裁委员会是依据《中华人民共和国仲裁法》组建的仲裁机构，也是广州地区唯一的民商事仲裁机构。\n\n仲裁不同于法院诉讼，其管辖基础主要来源于双方当事人的合意。因此，首先需要审查您的合同、订单、协议或补充协议中，是否明确约定将争议提交广州仲裁委员会、广州国际仲裁院，或其相关分会、专业仲裁平台仲裁。\n\n请您先提供：合同中关于“争议解决”“仲裁”“管辖”的条款截图或原文。\n便于我初步判断是否符合向广州仲裁委员会申请仲裁的条件。</div>'
            },
            {
                role: 'user',
